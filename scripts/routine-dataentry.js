...
function getUserAccessibleDataSet(){
    return dhis2.metadata.getMetaObject(null, 'ACCESSIBLE_DATASETS', '../../../api/dataSets.json', 'fields=id,access[data[write]]&paging=false', 'sessionStorage', dhis2.routineDataEntry.store);
}

function getSystemSetting(){
    return dhis2.metadata.getMetaObject(null, 'SYSTEM_SETTING', '../../../api/systemSettings', 'key=keyUiLocale&key=keyCalendar&key=keyDateFormat&key=multiOrganisationUnitForms', 'sessionStorage', dhis2.routineDataEntry.store);
}
